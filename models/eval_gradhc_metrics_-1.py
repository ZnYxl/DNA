...
运行:
  python eval_gradhc_metrics_-1.py 2>&1 | tee eval_gradhc.txt
"""
...
REFINED_LABELS = [
    os.path.join(EXP_DIR, "04_Iterative_Labels", "refined_labels_140626.txt"),  # Round 1
    os.path.join(EXP_DIR, "04_Iterative_Labels", "refined_labels_151851.txt"),  # Round 2
    os.path.join(EXP_DIR, "04_Iterative_Labels", "refined_labels_162641.txt"),  # Round 3
]
