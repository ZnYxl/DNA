...
# 数据集的真实标签文件
GT_FILE = "/mnt/st_data/liangxinyi/code/CC/Step0/给师妹的clover数据集/id20/id20_tags_reads.txt"

# 2. Clover 聚类输出文件 (Prediction)
# 对应 run_real_data_id20.py 生成的输出位置
CLOVER_OUT_FILE = "/mnt/st_data/liangxinyi/code/CC/Step0/Experiments/id20_Real/02_CloverOut/clover_result_merged.txt"
...
class CompactGroundTruth:
    ...
    def load(self, file_path):
        print(f"📖 [1/3] 正在加载 Ground Truth (id20)...")
        ...
        with open(file_path, 'r') as f:
            for i, line in enumerate(f):
                ...
                # id20 的 tag 是第一列 (例如 "4022", "153133")
                tag = parts[0]
...
if __name__ == "__main__":
    if not os.path.exists(CLOVER_OUT_FILE):
        ...
        print(f"   请先运行 run_real_data_id20.py 生成结果。")
        sys.exit(1)
