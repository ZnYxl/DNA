...
METHODS = [
    {
        "name": "Clover",
        "read_txt": "/mnt/st_data/liangxinyi/code/CC/Step0/Experiments/seq_1d/03_FedDNA_In/read.txt",
        "gt_tags":  "/mnt/st_data/liangxinyi/code/CC/Step0/Experiments/seq_1d/seq1d_tags_reads.txt",
    },
    {
        "name": "GradHC (q=8)",
        "read_txt": "/mnt/st_data/liangxinyi/code/CC/Step0/Experiments/seq_1d_gradhc/03_FedDNA_In/read.txt",
        "gt_tags":  "/mnt/st_data/liangxinyi/code/CC/Step0/Experiments/seq_1d_gradhc/seq1d_tags_reads.txt",
    },
]

N_GT_DESIGN = 11826   # design 总分子数（仅作参考打印）
